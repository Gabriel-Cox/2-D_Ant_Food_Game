...
## Description
A terminal based C++ simulation/game where the user as the ANT searches for and collects all of the FOOD to win. 
...
- Add graphics 
- Add time restriction or competitive element
- Add obstacles or enemies
- Change game for WASD users
